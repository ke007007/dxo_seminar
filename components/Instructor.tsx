...
export const Instructor: React.FC = () => {
  const members = [
    ...
    },
    {
      ...
      description: "経営者の孤独と現場の痛みを、誰よりも知る伴走者。\n祖父、父、親戚の多くが経営者という家系に育ち、幼少期から経営の責任と孤独を肌で感じて過ごす。自身も中小企業の役員として、全員の同意に縛られる重圧や、人を変えようと奔走する苦悩を経験。退任後、その葛藤を統合する中で辿り着いたのが「組織の問題は人ではなく、構造（OS）にある」というDXOの確信。\n現在は、経営者の隣に立つ伴走者として、個の力が自然と芽吹く組織へとファシリテートし、経営のDNAと現場の実践経験を糧に、あなたの「次の一歩」を応援している。"
    },
    {
      name: "ますえ（澤田 万寿江）",
